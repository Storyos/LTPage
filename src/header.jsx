        ...
        <div className='m-2 bg-white rounded-lg'>
                ...
                <nav className="bg-white rounded-lg shadow-md">
                    <ul className="flex justify-center py-4 space-x-6 text-gray-600">
                        ...
                        <li className="hover:text-blue-600"><a href="/gallery">데이터 분석</a></li>
                        ...
                        <li className="hover:text-blue-600" onClick={()=>{navigate("https://ticket.giantsclub.com/loginForm.do")}}>예매하기</li>
                    </ul>
                </nav>
            </div>
    )
